<%-- 
    Document   : insert
    Created on : Aug 22, 2021, 07:11:10 PM
    Author     : Quang Nhat
--%>
...
<html>
    <head>
        ...
        <title>Sunrise Auto - Insert</title>
    </head>
    <body>
        <header>
        ...
        <div class="container" style="background: white;display: flex;height: 1200px">
            <form style="margin-top: 150px" action="insert" method="post">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Quanlity</label>
                    <input  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="quanlity">
                </div>
                <div class="form-group">
