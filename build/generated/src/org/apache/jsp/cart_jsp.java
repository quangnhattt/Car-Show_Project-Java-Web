...
public final class cart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Sunrise Auto - Cart</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        <header>\n");
      ...
      out.write("        </header>\n");
      out.write("\n");
      out.write("        <div class=\"container\" style=\"background: white;height: 900px\">\n");
  ...
  private boolean _jspx_meth_c_when_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_2, PageContext _jspx_page_context)
    ...
    _jspx_th_c_when_3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.cart.size() eq 0||sessionScope.cart eq null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_when_3 = _jspx_th_c_when_3.doStartTag();
    if (_jspx_eval_c_when_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                    <div style=\"display: grid;justify-content: center;\">\n");
        out.write("                        <p style=\"font-size: 20px;text-align: center;opacity: 0.8\">Giỏ hàng của bạn còn trống</p>\n");
        out.write("                        <a style=\"text-align: center;text-decoration: none;color: white;background-color: #000000\" href=\"products#portfolio\">Mua hàng</a>\n");
        out.write("                    </div>\n");
        out.write("                ");
  ...
  private boolean _jspx_meth_c_otherwise_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_2, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_c_otherwise_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("                    <div style=\"display: flex;background-color: whitesmoke;margin: 0px 11px 15px 8px;padding: 20px 0 0 0px\">\n");
        out.write("                        <p style=\"font-size: 25px;margin-left: 25px\">Sản phẩm</p>\n");
        out.write("                        <p style=\"font-size: 25px;margin-left: 340px;\">Đơn giá</p>\n");
        out.write("                        <p style=\"font-size: 25px;margin-left: 100px\">Số lượng</p>\n");
        out.write("                        <p style=\"font-size: 25px;margin-left: 135px\">Số tiền</p>\n");
        out.write("                        <p style=\"font-size: 25px;margin-left: 70px\">Thao tác</p>\n");
        out.write("                    </div>\n");
        out.write("                    ");
        if (_jspx_meth_c_forEach_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_otherwise_2, _jspx_page_context))
          return true;
        out.write(" \n");
        out.write("                    <div style=\"display: flex;justify-content: flex-end;font-size: 23px;\">\n");
        out.write("                        <p style=\"margin: 15px 75px 0 0;\">Tổng tiền hàng</p> \n");
        out.write("                        <span style=\"margin: 15px 5px 0 0\">\n");
        out.write("                            ");
        if (_jspx_meth_c_set_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_otherwise_2, _jspx_page_context))
          return true;
        out.write("\n");
        out.write("                            ");
        ...
        out.write("\n");
        out.write("                            ");
        if (_jspx_meth_fmt_formatNumber_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_otherwise_2, _jspx_page_context))
          return true;
        out.write(" đ\n");
        out.write("                        </span>\n");
        out.write("                        <!--Thanh toan-->\n");
        out.write("                        <div style=\"margin: 20px 90px 20px 14px;\">\n");
        out.write("                            <a style=\"background-color: #000000;border: 10px solid #000000;text-decoration: none;color: white\" \n");
        out.write("                               href=\"\">Tư Vấn</a>\n");
        out.write("                        </div>\n");
        out.write("\n");
        out.write("                    </div>\n");
        out.write("\n");
        out.write("                    <div>\n");
        out.write("                        <a style=\"background-color: #000000;border: 10px solid #000000;text-decoration: none;color: white\"\n");
        out.write("                           href=\"products\">Quay lại trang chủ</a>\n");
        out.write("                        <a style=\"background-color: #000000;border: 10px solid #000000;text-decoration: none;color: white\"\n");
        out.write("                           href=\"removeall\">Xóa tất cả sản phẩm</a>\n");
        out.write("                    </div>\n");
        out.write("                    <!--check out-->\n");
        out.write("                ");
  ...
  private boolean _jspx_meth_c_forEach_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_2, PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\n");
          out.write("                        <div class=\"p-2 bd-highlight\" style=\"height: 163px;width: 300px;display: block;\">\n");
          out.write("                            <div class=\"link-amount\" style=\"width: 1200px;display: flex;background-color: whitesmoke\">\n");
          out.write("                                <!--anh-->\n");
          out.write("                                <img style=\"width: 300px;height: 150px\" src=\"assets/images/");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${cart.productImage}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\"/>\n");
          out.write("                                <!--id to name-->\n");
          out.write("                                <div style=\"font-size: 20px;margin: 40px 0 0 40px;\">\n");
          out.write("                                    <a style=\"color: #000000;text-decoration: none;margin-right: 40px;\"\n");
          out.write("                                       href=\"product-detail?id=");
          ...
          out.write("                                    <br>   \n");
          out.write("                                </div>\n");
          out.write("                                <!--So luong va nut + --->\n");
          out.write("                                <div style=\"display: inline-flex;margin:40px 40px 70px 50px;font-size: 20px;border: 1px solid #000000\">\n");
          out.write("                                    <!-- Dau - -->\n");
          out.write("                                    <a style=\"border-right:1px solid #000000;text-decoration: none;color: #000000;padding: 3px 13px 0 14px;\"\n");
          out.write("                                       href=\"updatecart?action=1&id=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${cart.productId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">-</a>\n");
          out.write("                                    <!--Soluong +--->\n");
          out.write("                                    <div style=\"width: 70px;text-align: center;padding-top: 4px;\" >\n");
          out.write("                                        ");
          ...
          out.write("</div>\n");
          out.write("                                    <!--Dau +-->\n");
          out.write("                                    <a style=\"border-left: 1px solid #000000;text-decoration: none;color: #000000;padding: 3px 12px 4px 10px;\"\n");
          out.write("                                       href=\"updatecart?action=2&id=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${cart.productId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">+</a>\n");
          out.write("                                </div>\n");
          ...
          out.write("                                <!--Delete-->\n");
          out.write("                                <div style=\"font-size: 20px;margin: 40px 0 0 40px;\">\n");
          out.write("                                    <a style=\"color: #000000;text-decoration: none;\"href=\"updatecart?action=3&id=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${cart.productId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">Delete</a>\n");
          out.write("                                </div>\n");
          out.write("                            </div>\n");
  ...
  private boolean _jspx_meth_c_set_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_set_0.setVar("price");
    _jspx_th_c_set_0.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${cart.productPrice}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_set_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_set_1.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${cart.productPrice}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_fmt_formatNumber_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_fmt_formatNumber_1.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${price*cart.amount}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_set_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_2, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:set
    ...
    _jspx_th_c_set_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_otherwise_2);
  ...
  private boolean _jspx_meth_c_set_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_set_3.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${total + cart.amount*cart.productPrice}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_fmt_formatNumber_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_2, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  fmt:formatNumber
    org.apache.taglibs.standard.tag.rt.fmt.FormatNumberTag _jspx_th_fmt_formatNumber_2 = (org.apache.taglibs.standard.tag.rt.fmt.FormatNumberTag) _jspx_tagPool_fmt_formatNumber_value_type_maxIntegerDigits_nobody.get(org.apache.taglibs.standard.tag.rt.fmt.FormatNumberTag.class);
    _jspx_th_fmt_formatNumber_2.setPageContext(_jspx_page_context);
    _jspx_th_fmt_formatNumber_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_otherwise_2);
    _jspx_th_fmt_formatNumber_2.setType("number");
    _jspx_th_fmt_formatNumber_2.setMaxIntegerDigits(11);
    ...
    if (_jspx_th_fmt_formatNumber_2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_fmt_formatNumber_value_type_maxIntegerDigits_nobody.reuse(_jspx_th_fmt_formatNumber_2);
      return true;
    }
    _jspx_tagPool_fmt_formatNumber_value_type_maxIntegerDigits_nobody.reuse(_jspx_th_fmt_formatNumber_2);
    return false;
