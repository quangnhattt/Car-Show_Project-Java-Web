<%-- 
    ...
    Created on : Aug 22, 2021, 08:35:03 PM
    Author     : Quang Nhat
--%>
...
<html>
    <head>
        ...
        <title>Sunrise Auto - Product</title>
    </head>
    <body>
...
<!--                                        <a href="cart.jsp" class="fas fa-shopping-cart" style="font-size: 20px;text-decoration: none;color: white;margin-top: 10px;">Cart</a>
